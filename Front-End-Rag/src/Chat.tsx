...
const ChatPage: React.FC = () => {
  ...
  // Set initial bot message for each chat
  useEffect(() => {
    if (activeChatId === 1) {
      setMessages([
        {
  ...
  return (
    <div className="flex h-screen bg-[#F0F2F5] text-gray-900 font-sans">
      ...
      <div className="flex flex-col flex-1">
        {/* Header */}
        <header className="py-4 px-6 shadow-md sticky top-0 z-20 flex items-center justify-between bg-white">
          ...
          <button
            ...
            className="bg-[#005DAA] hover:bg-[#004B8D] text-white px-4 py-2 rounded-xl text-sm font-semibold transition"
          >
            Logout
          </button>
        </header>
